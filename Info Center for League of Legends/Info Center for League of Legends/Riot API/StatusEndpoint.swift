...
class StatusEndpoint: NSObject {
    func getAllShards(_ completion: @escaping (_ shards: [Shard]) -> Void, errorBlock: @escaping () -> Void) {
    ...
    func getShardStatus(_ completion: @escaping (_ shardStatus: ShardStatus) -> Void, errorBlock: @escaping () -> Void) {
